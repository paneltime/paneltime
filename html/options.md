...
|h_dict|{'h': '', 'h_e': '', 'h_e2': '', 'h_z': '', 'h_z2': '', 'h_e_z': ''}|None|dict|<b>GARCH function:</b> You can supply your own GARCH heteroskedasticity function. Se 'GARCH heteroskedasticity function syntax guide' in the documentation for information on how to write the mathematical expressions.|
